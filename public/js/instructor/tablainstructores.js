...
const tabla = document.getElementById("tablaInstrutores");
...
btnNuevoJugador.addEventListener("click", (e) => {
    e.preventDefault();
    abrirModalRegistro("/streepsoft/instructores/crear");
});

tbody.addEventListener("click", (e) => {
    const botonEditar = e.target.closest(".btn-editar");
    if(botonEditar){
        abrirModalRegistro("/streepsoft/instructores/editar/" + botonEditar.dataset.idInstructor);
    }
})

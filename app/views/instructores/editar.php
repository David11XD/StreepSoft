    ...
    <div class="contenedor">
        <div class="contenedor-pagina-1">
            ...
            <div class="encabezado">
                <div class="titulo">
                    <h1 id="tituloFormulario">Editar Instructor</h1>
                    <i class="mingcute--user-add-fill"></i>
                </div>
                
                <p id="subtituloFormulario">Complete los campos para Editar a un instructor</p>      
            </div>
        ...
        <form action="/streepsoft/instructores/actualizar/<?= (int) $instructor['id_instructor']  ?>" method="POST" enctype="multipart/form-data" id="formjugador" target="_top">
            <input type="hidden" name="_token" value="<?= htmlspecialchars($_SESSION['csrf_token'] ?? '') ?>">
            <input type="hidden" name="id_instructor" value="<?=  (int) $instructor['id_instructor'] ?>">
            <input type="hidden" id="modoFormulario" name="modo" value="editar">
                    ...
                    <div>
                        ...
                        <div class="grid-2">
                            <div class="grupo">
                                ...
                                <input type="text"
                                    name="apellidos"
                                    value="<?= htmlspecialchars($instructor['apellidos'] ?? '') ?>"
                            ...
                            <div class="grupo">
                                ...
                                <input type="text"
                                    name="nombres"
                                    value="<?= htmlspecialchars($instructor['nombres'] ?? '') ?>"
                                    placeholder="Obligatorio" required>
                            </div>
                            ...
                            <div class="grupo">
                                ...
                                <input type="text"
                                    inputmode="numeric"
                                    name="edad"
                                    value="<?= htmlspecialchars($instructor['edad'] ?? '') ?>"
                                    maxlength="2"
                                    required>
                            </div>
                            ...
                            <div class="grupo">
                                ...
                                <input type="text"
                                    name="numero_celular"
                                    value="<?= htmlspecialchars($instructor['numero_celular'] ?? '') ?>"
                                ...
                                <select name="id_categorias" required>
                                    ...
                                    <?php foreach ($categorias as $cat): ?>
                                        <option value="<?= (int) $cat['id_categorias'] ?>"
                                                <?= ((int)($instructor['id_categorias'] ?? 0) === (int)$cat['id_categorias']) ? 'selected' : '' ?>>
